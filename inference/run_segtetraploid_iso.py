...
def segtetraploid_iso(params, ns, pts):
    ...
    T2: Time since polyploid formation
...
if __name__ == "__main__":
    with open('segtetraploid_iso.txt', 'w') as f_out:
        ...
        for T1 in [0.5, 1.0, 1.5, 2.0]:
            for T2 in [0.25, 0.5, 1.0]:
                for eij in [0.001, 0.01, 0.1]:
                    ...
                    print(f"## Eigendecomposition of Hessian for params T1,T2,eij = {p_true[1:]}:\n", file=f_out)
